...
<section class="video-sec dark" id="video" style="background-image:url(assets/img/banner-10.jpg);">
    <div class="container">
        ...
        <div class="video-part">
            <video src="asset/images/VIDEO.mp4" >
                
            </video>
        <a href="#" data-toggle="modal" data-target="#unBann" class="video-btn"><i
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                 <video src="assets/images/VIDEO.mp4" width="580px" height="500px" controls="">
